          ...
          <Card.Body>
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-3">
                ...
                <Form.Text className="text-muted float-right">{convertBTCtoSatoshi(paymentInfo.amount)} SAT</Form.Text>
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Text className="text-muted float-right">Noch {30 - paymentInfo.description.length} Zeichen</Form.Text>
              </Form.Group>
